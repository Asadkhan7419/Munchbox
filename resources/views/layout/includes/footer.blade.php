            ...
            <div class="row">
                <div class="col-xl col-lg-4 col-md-4 col-sm-6">
                    <div class="footer-contact">
                        ...
                        <ul>
                            <li class="fw-600"><span class="text-light-white">Call Us</span> <a href="tel:" class="text-custom-white">{{$setting->phone_no ?? ''}}</a>
                            </li>
                            <li class="fw-600"><span class="text-light-white">Email Us</span> <a href="mailto:" class="text-custom-white">{{$setting->email ?? ''}}</a>
                            </li>
    ...
    <div class="copyright bg-black">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="copyright-text"> <span class="text-light-white"><a href="templateshub.net">{{$setting->copyright ?? ''}}</a> </span>
                    </div>
                </div>
            </div>
        </div>
